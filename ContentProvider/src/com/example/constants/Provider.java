...
public class Provider extends ContentProvider {
	...
	public static final class Constants implements BaseColumns {
		public static final Uri CONTENT_URI
				  = Uri.parse("content://com.example.constants.Provider/constants");
	...
	static {
		...
		MATCHER.addURI("com.example.constants.Provider", "constants", CONSTANTS);
		MATCHER.addURI("com.example.constants.Provider", "constants/#", CONSTANT_ID);
	...
	private String getCollectionType() {
		return("vnd.android.cursor.dir/vnd.example.constant");
	}
	
	private String getSingleType() {
		return("vnd.android.cursor.item/vnd.example.constant");
	}
